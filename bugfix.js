...
/* =========================
   [BUGFIX-016] 聊天页顶部间隙 + 头像圆形修复
========================= */
(function(){
  if(window.__TQ_BF016__) return;
  window.__TQ_BF016__ = 1;

  const st = document.createElement('style');
  st.id = 'tq-bugfix-016-style';
  st.textContent = `
    /* 修复1：顶部黑条 —— 给顶栏加上安全区高度 */
    #app-chat .chat-topbar{
    ...
    /* 红点移到头像外面（不依赖 overflow:visible） */
    .msg-item-avatar{
      position: relative !important;
    }
    .msg-item-avatar .msg-badge{
      position: absolute !important;
      top: -4px !important;
      right: -4px !important;
